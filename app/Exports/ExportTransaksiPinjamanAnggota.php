...
class ExportTransaksiPinjamanAnggota implements FromCollection, WithHeadings, WithEvents, WithMapping, WithStyles
{
    protected $userId;
    ...
    {
        // Mengambil data dari tabel user dengan relasi pinjaman, tanggungan, dan transaksi_pinjaman untuk anggota tertentu
        $data = User::with(['pinjaman.tanggungan.transaksiPinjaman'])
                ...
                foreach ($pinjaman->tanggungan as $tanggungan) {
                    foreach ($tanggungan->transaksiPinjaman as $transaksiPinjaman) {
                        $exportData->push([
                            ...
                            'Keterangan' => $transaksiPinjaman->keterangan ?? 'Belum Ada Keterangan',
                        ]);
                        $isFirstRow = false;
                    }
                }
