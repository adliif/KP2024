                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-lg-4">
                                            <div class="form-group">
                                                <div class="max-w-xl">
                                                    @include('roleAdmin.profile.partials.update-profile-information-form')
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6 col-lg-4">
                                            <div class="form-group">
                                                <div class="max-w-xl">
                                                    @include('roleAdmin.profile.partials.update-password-form')
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6 col-lg-4">
                                            <div class="form-group">
                                                <div class="max-w-xl">
                                                    @include('roleAdmin.profile.partials.delete-user-form')
                                                </div>
                                            </div>
                                        </div>
                                    </div>
